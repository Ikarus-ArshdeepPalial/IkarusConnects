"""
Django settings for universal_connector project.
"""
...
MIDDLEWARE = [
    ...
    "core.middleware.DisableCSRFOnAPI", # Custom Middleware
...
ROOT_URLCONF = 'universal_connector.urls'
...
WSGI_APPLICATION = 'universal_connector.wsgi.application'
